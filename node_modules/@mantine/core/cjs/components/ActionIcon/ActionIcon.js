...
const ActionIcon = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("ActionIcon", defaultProps, props), {
    className,
    color,
    children,
    radius,
  ...
  const { classes, cx, theme } = ActionIcon_styles['default']({ size, radius, color }, { name: "ActionIcon", classNames, styles: styles$1 });
