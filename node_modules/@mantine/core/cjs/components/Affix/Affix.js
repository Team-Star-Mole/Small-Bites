...
const Affix = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Affix", defaultProps, props), { target, position, zIndex, sx } = _a, others = __objRest(_a, ["target", "position", "zIndex", "sx"]);
  return /* @__PURE__ */ React__default.createElement(Portal.Portal, {
    zIndex,
    target
  }, /* @__PURE__ */ React__default.createElement(Box.Box, __spreadValues({
    sx: [__spreadValues({ position: "fixed" }, position), ...Array.isArray(sx) ? sx : [sx]],
    ref
  }, others)));
});
