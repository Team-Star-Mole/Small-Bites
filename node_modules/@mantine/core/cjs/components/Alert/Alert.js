...
const Alert = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Alert", defaultProps, props), {
    id,
    className,
    title,
    variant,
  ...
  const { classes, cx } = Alert_styles['default']({ color, radius, variant }, { classNames, styles: styles$1, name: "Alert" });
