...
const AppShell = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("AppShell", defaultProps, props), {
    children,
    navbar,
    header,
    footer,
  ...
  const { classes, cx } = AppShell_styles['default']({ padding, fixed, navbarOffsetBreakpoint, asideOffsetBreakpoint }, { styles: styles$1, classNames, name: "AppShell" });
