...
const AvatarsGroup = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("AvatarsGroup", defaultProps, props), {
    className,
    children,
    size = "md",
    radius = "xl",
  ...
  const { classes, cx } = AvatarsGroup_styles['default']({ spacing }, { classNames, styles: styles$1, name: "AvatarsGroup" });
