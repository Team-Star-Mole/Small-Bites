...
const Blockquote = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Blockquote", defaultProps, props), { className, color, icon, cite, children, classNames, styles: styles$1 } = _a, others = __objRest(_a, ["className", "color", "icon", "cite", "children", "classNames", "styles"]);
  const { classes, cx } = Blockquote_styles['default']({ color }, { classNames, styles: styles$1, name: "Blockquote" });
