...
const Breadcrumbs = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Breadcrumbs", defaultProps, props), { className, children, separator, classNames, styles: styles$1 } = _a, others = __objRest(_a, ["className", "children", "separator", "classNames", "styles"]);
  const { classes, cx } = Breadcrumbs_styles['default'](null, { classNames, styles: styles$1, name: "Breadcrumbs" });
