...
const Checkbox = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Checkbox", defaultProps, props), {
    className,
    style,
    sx,
    checked,
  ...
  const { classes, cx } = Checkbox_styles['default']({ size, radius, color, transitionDuration }, { classNames, styles: styles$1, name: __staticSelector });
