...
function Collapse(props) {
  const _a = styles.useMantineDefaultProps("Collapse", defaultProps, props), {
    children,
    in: opened,
    transitionDuration,
  ...
  return /* @__PURE__ */ React__default.createElement(Box.Box, __spreadValues({}, getCollapseProps(__spreadValues(__spreadValues({ style }, rest), systemStyles))), /* @__PURE__ */ React__default.createElement("div", {
    style: {
