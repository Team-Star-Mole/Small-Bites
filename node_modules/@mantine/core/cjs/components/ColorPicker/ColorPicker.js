...
const ColorPicker = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("ColorPicker", defaultProps, props), {
    value,
    defaultValue,
    onChange,
    format,
  ...
  const { classes, cx, theme } = ColorPicker_styles['default']({ size, fullWidth }, { classNames, styles: styles$1, name: __staticSelector });
