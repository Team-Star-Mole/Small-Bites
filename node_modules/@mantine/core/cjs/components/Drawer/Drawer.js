...
function Drawer(props) {
  const _a = styles.useMantineDefaultProps("Drawer", defaultProps, props), {
    className,
    opened,
    onClose,
    position,
  ...
  const { classes, cx, theme } = Drawer_styles['default']({ size, position, zIndex }, { classNames, styles: styles$1, name: "Drawer" });
  ...
  hooks.useFocusReturn({ opened, transitionDuration: 0, shouldReturnFocus: trapFocus });
