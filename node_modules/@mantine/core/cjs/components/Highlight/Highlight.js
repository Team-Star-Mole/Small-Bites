...
const Highlight = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Highlight", defaultProps, props), { children, highlight, highlightColor, component, highlightStyles } = _a, others = __objRest(_a, ["children", "highlight", "highlightColor", "component", "highlightStyles"]);
