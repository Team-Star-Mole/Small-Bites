...
const NativeSelect = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("NativeSelect", defaultProps, props), {
    id,
    className,
    required,
    label,
  ...
  return /* @__PURE__ */ React__default.createElement(InputWrapper.InputWrapper, __spreadValues(__spreadValues({
    ...
    descriptionProps,
    labelProps
  }, systemStyles), wrapperProps), /* @__PURE__ */ React__default.createElement(Input.Input, __spreadValues(__spreadProps(__spreadValues({}, rest), {
    onChange,
    component: "select",
    invalid: !!error,
    style: inputStyle,
