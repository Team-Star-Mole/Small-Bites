...
const Notification = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Notification", {}, props), {
    className,
    color,
    radius,
    loading,
  ...
  const { classes, cx } = Notification_styles['default']({ color, radius }, { classNames, styles: styles$1, name: "Notification" });
