...
const NumberInput = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("NumberInput", defaultProps, props), {
    disabled,
    value,
    onChange,
    decimalSeparator,
  ...
  const { classes, cx, theme } = NumberInput_styles['default']({ radius, size }, { classNames, styles: styles$1, name: "NumberInput" });
  ...
  return /* @__PURE__ */ React__default.createElement(TextInput.TextInput, __spreadProps(__spreadValues({}, others), {
    ...
    styles: styles$1,
    classNames,
    inputMode: getInputMode.getInputMode(step, precision, hooks.useOs()),
