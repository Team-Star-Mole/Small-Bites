...
const Pagination = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Pagination", defaultProps, props), {
    itemComponent: Item,
    classNames,
    styles: styles$1,
    page,
  ...
  const { classes, cx, theme } = Pagination_styles['default']({ color, size, radius }, { classNames, styles: styles$1, name: "Pagination" });
