...
const PasswordInput = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("PasswordInput", defaultProps, props), {
    radius,
    disabled,
    size,
    toggleTabIndex,
  ...
  const { classes, cx } = PasswordInput_styles['default']({ size, rightSectionWidth }, { name: "PasswordInput", classNames, styles: styles$1 });
