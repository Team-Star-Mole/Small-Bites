...
const Progress = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Progress", defaultProps, props), {
    className,
    value,
    color,
    size,
  ...
  const { classes, cx, theme } = Progress_styles['default']({ color, size, radius, striped: striped || animate, animate }, { classNames, styles: styles$1, name: "Progress" });
