...
const RingProgress = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("RingProgress", defaultProps, props), {
    className,
    style,
    label,
    sections,
  ...
  const { classes, cx } = RingProgress_styles['default'](null, { classNames, styles: styles$1, name: "RingProgress" });
