...
var useStyles = styles.createStyles((theme, { color, size, disabled }) => ({
  label: {
    position: "absolute",
    top: -36,
  ...
  thumb: __spreadProps(__spreadValues({}, theme.fn.focusStyles()), {
    ...
    height: theme.fn.size({ sizes: SliderRoot_styles.sizes, size }) * 2,
    width: theme.fn.size({ sizes: SliderRoot_styles.sizes, size }) * 2,
