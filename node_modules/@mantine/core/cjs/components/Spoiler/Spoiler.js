...
const Spoiler = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Spoiler", defaultProps, props), {
    className,
    children,
    maxHeight,
    hideLabel,
  ...
  const { classes, cx } = Spoiler_styles['default']({ transitionDuration }, { classNames, styles: styles$1, name: "Spoiler" });
