...
const Stepper = React.forwardRef((props, ref) => {
  var _b, _c, _d;
  const _a = styles.useMantineDefaultProps("Stepper", defaultProps, props), {
    className,
    children,
    onStepClick,
    active,
  ...
  const { classes, cx } = Stepper_styles['default']({ contentPadding, color, orientation, iconPosition, size, iconSize, breakpoint }, { classNames, styles: styles$1, name: "Stepper" });
  ...
  const stepContent = (_c = (_b = filteredChildren[active]) == null ? void 0 : _b.props) == null ? void 0 : _c.children;
