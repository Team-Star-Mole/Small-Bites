...
const Table = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Table", defaultProps, props), {
    className,
    children,
    striped,
    highlightOnHover,
  ...
  const { classes, cx } = Table_styles['default']({ captionSide, verticalSpacing, horizontalSpacing, fontSize }, { name: "Table" });
