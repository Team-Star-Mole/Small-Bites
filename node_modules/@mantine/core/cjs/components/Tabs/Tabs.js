...
const Tabs = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("Tabs", defaultProps, props), {
    className,
    children,
    initialTab,
    active,
  ...
  const { classes, cx, theme } = Tabs_styles['default']({ tabPadding, orientation }, { classNames, styles: styles$1, name: "Tabs" });
