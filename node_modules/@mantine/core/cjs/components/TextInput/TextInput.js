...
const TextInput = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("TextInput", defaultProps, props), {
    className,
    id,
    label,
    error,
  ...
  return /* @__PURE__ */ React__default.createElement(InputWrapper.InputWrapper, __spreadValues(__spreadValues({
    ...
    labelProps,
    descriptionProps
  }, systemStyles), wrapperProps), /* @__PURE__ */ React__default.createElement(Input.Input, __spreadProps(__spreadValues({}, rest), {
    required,
    ref,
    id: uuid,
    type,
