...
const TypographyStylesProvider = React.forwardRef((props, ref) => {
  const _a = styles.useMantineDefaultProps("TypographyStylesProvider", {}, props), { className } = _a, others = __objRest(_a, ["className"]);
  const { classes, cx } = TypographyStylesProvider_styles['default'](null, { name: "TypographyStylesProvider" });
