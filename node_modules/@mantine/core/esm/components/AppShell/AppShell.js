...
const AppShell = forwardRef((props, ref) => {
  const _a = useMantineDefaultProps("AppShell", defaultProps, props), {
    children,
    navbar,
    header,
    footer,
  ...
  const { classes, cx } = useStyles({ padding, fixed, navbarOffsetBreakpoint, asideOffsetBreakpoint }, { styles, classNames, name: "AppShell" });
