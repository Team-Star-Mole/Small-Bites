...
const Blockquote = forwardRef((props, ref) => {
  const _a = useMantineDefaultProps("Blockquote", defaultProps, props), { className, color, icon, cite, children, classNames, styles } = _a, others = __objRest(_a, ["className", "color", "icon", "cite", "children", "classNames", "styles"]);
