...
const Breadcrumbs = forwardRef((props, ref) => {
  const _a = useMantineDefaultProps("Breadcrumbs", defaultProps, props), { className, children, separator, classNames, styles } = _a, others = __objRest(_a, ["className", "children", "separator", "classNames", "styles"]);
