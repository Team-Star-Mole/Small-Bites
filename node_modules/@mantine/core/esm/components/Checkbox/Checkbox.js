...
const Checkbox = forwardRef((props, ref) => {
  const _a = useMantineDefaultProps("Checkbox", defaultProps, props), {
    className,
    style,
    sx,
    checked,
  ...
  const { classes, cx } = useStyles({ size, radius, color, transitionDuration }, { classNames, styles, name: __staticSelector });
