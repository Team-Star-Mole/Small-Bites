...
const Code = forwardRef((props, ref) => {
  const _a = useMantineDefaultProps("Code", {}, props), { className, children, block, color, styles, classNames } = _a, others = __objRest(_a, ["className", "children", "block", "color", "styles", "classNames"]);
