...
const ColorSwatch = forwardRef((props, ref) => {
  const _a = useMantineDefaultProps("ColorSwatch", defaultProps, props), { component, color, size, radius, className, children, classNames, styles } = _a, others = __objRest(_a, ["component", "color", "size", "radius", "className", "children", "classNames", "styles"]);
