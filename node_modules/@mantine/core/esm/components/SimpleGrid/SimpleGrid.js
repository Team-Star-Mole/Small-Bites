...
const SimpleGrid = forwardRef((props, ref) => {
  const _a = useMantineDefaultProps("SimpleGrid", defaultProps, props), { className, breakpoints, cols, spacing, children, classNames, styles } = _a, others = __objRest(_a, ["className", "breakpoints", "cols", "spacing", "children", "classNames", "styles"]);
