...
import { DefaultProps, MantineNumberSize, Selectors, MantineStyleSystemSize } from '@mantine/styles';
import { MantineTransition } from '../Transition';
import { PaperProps } from '../Paper/Paper';
import useStyles from './Dialog.styles';
export declare type DialogStylesNames = Selectors<typeof useStyles>;
export interface DialogProps extends Omit<DefaultProps<DialogStylesNames>, MantineStyleSystemSize>, Omit<PaperProps<'div'>, 'classNames' | 'styles'> {
...
export declare function MantineDialog(props: DialogProps): JSX.Element;
