...
import { DefaultProps, MantineNumberSize, MantineShadow, Selectors, ForwardRefWithStaticComponents } from '@mantine/styles';
...
export declare type MenuStylesNames = Selectors<typeof useStyles> | MenuItemStylesNames | MenuLabelStylesNames;
