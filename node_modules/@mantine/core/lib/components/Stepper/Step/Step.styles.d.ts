...
declare const _default: (params: StepStylesParams, options?: import("@mantine/styles").UseStylesOptions<"step" | "stepLoader" | "stepIcon" | "stepCompletedIcon" | "stepProgress" | "stepCompleted" | "stepBody" | "stepLabel" | "stepDescription">) => {
