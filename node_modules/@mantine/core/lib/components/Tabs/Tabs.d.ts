...
import { DefaultProps, MantineNumberSize, MantineColor, Selectors, ForwardRefWithStaticComponents } from '@mantine/styles';
...
export declare type TabsStylesNames = Exclude<Selectors<typeof useStyles>, TabsVariant> | TabControlStylesNames;
